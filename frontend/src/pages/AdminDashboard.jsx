...
function AdminDashboard() {
  ...
  return (
    <div className="bg-light min-vh-100 pb-5">
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark shadow-sm mb-5">
        <div className="container-fluid px-4">
          ...
          <div className="d-flex align-items-center gap-3">
            <span className="text-white d-none d-md-block">Xin chào, {user?.name || user?.fullName}</span>
      ...
      <div className="container-fluid px-4 dashboard-container pt-0">
                    ...
                    <tr key={u._id}>
                      ...
                      <td>
                        {u.role === "Admin" ? (
                          ...
                          <select 
                            ...
                            disabled={user.role !== "Admin" || u._id === user.id} // Only Admin can change, cannot change self
                          >
                            <option value="Manager">Manager</option>
                            <option value="Employee">Employee</option>
                            <option value="User">User</option>
                      ...
                      <td className="text-end pe-4">
                        <button 
                          ...
                          disabled={u._id === user.id || u.role === "Admin"} // Cannot block self or Admin
